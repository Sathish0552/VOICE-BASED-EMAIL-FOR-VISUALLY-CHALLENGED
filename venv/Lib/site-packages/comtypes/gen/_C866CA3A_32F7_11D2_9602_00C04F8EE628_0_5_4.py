...
__all__ = [
    'DISPID_SPEEngineConfidence', 'SPEI_MAX_SR', 'SPEI_SOUND_START',
    'Speech_Max_Pron_Length', 'SPBO_NONE', 'SVPOver',
    'ISpeechPhraseElements', 'SPFM_CREATE_ALWAYS', 'SREAudioLevel',
    'SVEAudioLevel', 'SDTLexicalForm', 'SPPHRASEPROPERTY',
    'SpeechGrammarTagWildcard', 'SGRSTTEpsilon', 'SGRSTTDictation',
    'DISPID_SGRSTNextState', 'DISPID_SRCEEndStream',
    'DISPID_SpeechPhraseReplacements', 'ISpStream', 'DISPID_SRState',
    'Speech_Max_Word_Length', 'tagSTATSTG',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPRuleConfidence',
    'SPSTREAMFORMATTYPE', 'SASClosed', 'ISpeechPhraseAlternates',
    'DISPID_SpeechPhraseInfo', 'DISPID_SLGetGenerationChange',
    'eLEXTYPE_PRIVATE5', 'SpeechVoicePriority',
    'DISPID_SABIBufferSize', 'SPPS_Verb', 'DISPID_SPRs_NewEnum',
    'IInternetSecurityManager', 'DISPID_SpeechObjectToken', 'SVP_2',
    'DISPID_SPRText', 'SPDATAKEYLOCATION', 'eLEXTYPE_RESERVED7',
    'DISPID_SpeechRecoResult', 'SRERecoOtherContext',
    'DISPIDSPTSI_SelectionLength', 'SpeechVoiceCategoryTTSRate',
    'SpeechTokenIdUserLexicon', 'SGPronounciation', 'ISpPhrase',
    'DISPID_SpeechVoiceEvent', 'eLEXTYPE_RESERVED10',
    'ISpRecoGrammar', 'DISPID_SCSBaseStream',
    'DISPID_SGRSAddWordTransition', 'SECFDefault',
    'DISPID_SPRulesItem', 'SPPS_RESERVED2', 'SPVPRIORITY',
    'DISPID_SPELexicalForm', 'tagSPPROPERTYINFO',
    'DISPID_SDKDeleteValue', 'SpCompressedLexicon',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SPEDisplayText',
    'ISpLexicon', 'SAFT8kHz16BitMono',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRCERequestUI',
    'SRESoundStart', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SPEAudioSizeTime', 'SGLexical',
    'SpeechVoiceSkipTypeSentence', 'Speech_StreamPos_Asap',
    'ISpeechObjectTokens', 'SSFMCreate', 'DISPID_SGRSTs_NewEnum',
    'SRSActiveAlways', 'SPSERIALIZEDPHRASE', 'DISPID_SVDisplayUI',
    'SPPS_Function', 'SPVOICESTATUS', 'DISPID_SPIRetainedSizeBytes',
    'SECFIgnoreCase', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SPPs_NewEnum', 'SRAORetainAudio',
    'DISPID_SpeechAudioStatus', 'DISPID_SDKCreateKey',
    'SPINTERFERENCE', 'SAFTCCITT_uLaw_44kHzStereo', 'STSF_AppData',
    'DISPID_SGRSTPropertyValue', 'SPRECOGNIZERSTATUS',
    'SpResourceManager', 'SPEI_INTERFERENCE',
    'DISPID_SVSLastBookmarkId', 'SAFTCCITT_ALaw_44kHzMono',
    'SPDKL_CurrentUser', 'SpeechTokenValueCLSID',
    'SAFTGSM610_11kHzMono', 'SpeechDataKeyLocation', 'SPFILEMODE',
    'SPSHORTCUTPAIR', 'SGSEnabled', 'eLEXTYPE_PRIVATE12',
    'SPINTERFERENCE_NONE', 'DISPID_SRGDictationSetState',
    'SPGRAMMARWORDTYPE', 'DISPID_SVGetAudioInputs',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SpeechGrammarRule',
    'DISPID_SVIsUISupported', 'DISPID_SPIEngineId',
    'DISPID_SMSGetData', 'DISPID_SVGetVoices',
    'SAFTADPCM_22kHzStereo', 'SpSharedRecognizer', 'SPFM_NUM_MODES',
    'SpeechGrammarWordType', 'DISPID_SVEventInterests',
    'DISPID_SGRSTsItem', 'DISPID_SRCSetAdaptationData',
    'SpeechAllElements', 'DISPID_SRCEPropertyNumberChange',
    'SPINTERFERENCE_TOOFAST', 'SpWaveFormatEx', 'SRSInactive',
    'ISpRecognizer2', 'DISPID_SGRInitialState',
    'DISPID_SABIMinNotification', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SRAudioInputStream', 'SAFTADPCM_11kHzMono',
    'DISPID_SPCPhoneToId', 'SAFTExtendedAudioFormat',
    'DISPID_SLWType', 'SDTRule', 'DISPID_SRGRecoContext',
    'DISPID_SLWWord', 'SpeechRecoEvents',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRSAudioStatus',
    'eLEXTYPE_RESERVED9', 'SAFT44kHz8BitMono', 'SREBookmark',
    'ISpeechGrammarRules', 'DISPID_SLPsItem', 'SVSFUnusedFlags',
    'SpeechWordType', 'SpeechStreamFileMode', 'DISPID_SGRSTType',
    'SVEBookmark', 'SpSharedRecoContext', 'SPSFunction',
    'DISPID_SPEPronunciation', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRGetRecognizers', 'DISPID_SpeechDataKey',
    'DISPID_SVSLastStreamNumberQueued', 'SVESentenceBoundary',
    'SAFT48kHz16BitStereo', 'DISPID_SGRAddResource', 'SPSHT_OTHER',
    'DISPID_SRCESoundStart', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SRGCmdSetRuleIdState', 'SP_VISEME_19',
    'DISPID_SGRSTWeight', 'DISPID_SRCRecognizer',
    'ISpeechGrammarRuleState', 'SPSVerb',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SVEEnginePrivate',
    'SREFalseRecognition', 'SPEI_WORD_BOUNDARY', 'SpeechPartOfSpeech',
    'SpeechCategoryVoices', 'IEnumString', 'eWORDTYPE_DELETED',
    'WAVEFORMATEX', 'SAFT11kHz16BitStereo', 'SP_VISEME_4',
    'SpeechGrammarState', 'DISPID_SpeechAudioBufferInfo',
    'SDKLDefaultLocation', 'SITooQuiet', 'DISPID_SGRSTRule',
    'SAFTADPCM_11kHzStereo', 'DISPID_SPEs_NewEnum',
    '_ISpeechVoiceEvents', 'SGRSTTWord', '_RemotableHandle',
    'DISPID_SPIGetText', 'SpeechRecoProfileProperties',
    'SVSFIsFilename', 'SpeechGrammarTagUnlimitedDictation',
    'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'ISpeechRecoResultDispatch', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechWaveFormatEx', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SPAs_NewEnum', 'DISPID_SMSAMMHandle',
    'SPEI_RECO_OTHER_CONTEXT', 'SPEI_RESERVED5',
    'SAFT44kHz8BitStereo', 'SPPROPERTYINFO', 'SVEPrivate',
    'ISpRecognizer3', 'DISPID_SPPValue', 'STCInprocHandler',
    'DISPID_SRCCreateResultFromMemory', 'eLEXTYPE_PRIVATE3', 'SVP_1',
    'DISPID_SGRId', 'DISPID_SBSFormat', 'DISPID_SVPriority', 'SVP_13',
    'SpeechAudioFormatGUIDText', 'DISPID_SPACommit',
    'DISPID_SPRsItem', 'SPWT_PRONUNCIATION', 'SRAInterpreter',
    'DISPID_SRCEStartStream', 'SPPS_Noun', 'ISpeechPhraseProperties',
    'SP_VISEME_10', 'SpeechGrammarTagDictation', 'DISPID_SGRsCount',
    'DISPID_SRRSaveToMemory', 'DISPID_SPIAudioSizeTime',
    'DISPID_SMSALineId', 'SpeechTokenKeyFiles', 'SPCT_SLEEP',
    'SPAUDIOSTATUS', 'SPBO_PAUSE', 'SPAS_PAUSE', 'SPCT_DICTATION',
    'SPVPRI_ALERT', 'SPLO_DYNAMIC', 'SPCATEGORYTYPE',
    'SGDSActiveWithAutoPause', 'DISPID_SOTRemoveStorageFileName',
    'SRADefaultToActive', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPRFirstElement', 'ISpEventSink', 'ISpEventSource',
    'SpeechRecoContextState', 'ISpeechCustomStream',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPPEngineConfidence',
    'SpMMAudioEnum', 'DISPID_SpeechPhraseBuilder', 'STCLocalServer',
    'SSFMOpenForRead', 'SPPS_RESERVED4', 'SVSFPurgeBeforeSpeak',
    'SRARoot', 'eLEXTYPE_USER_SHORTCUT', 'SRSActive',
    'DISPID_SPPParent', 'SDTPronunciation', 'SDA_Two_Trailing_Spaces',
    'DISPID_SREmulateRecognition', 'DISPID_SpeechCustomStream',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRCRequestedUIType',
    'DISPID_SVEStreamStart', 'ISpRecoCategory', 'SpShortcut',
    'SAFT24kHz16BitStereo', 'SPEI_VISEME', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRSCurrentStreamNumber', 'SDKLCurrentUser',
    'SPAUDIOOPTIONS', 'DISPID_SRGCmdLoadFromObject',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SDKGetStringValue', 'SRSEDone',
    'ISpeechWaveFormatEx', 'SVSFlagsAsync', 'SLODynamic',
    'SECFIgnoreKanaType', 'eWORDTYPE_ADDED', 'SPEI_HYPOTHESIS',
    'DISPID_SRCEEnginePrivate', 'ISpeechPhoneConverter',
    'SPPHRASEELEMENT', 'SITooLoud', 'SRAImport', 'DISPID_SVPause',
    'SPFM_OPEN_READONLY', 'SAFTADPCM_22kHzMono', 'ISpObjectWithToken',
    'DISPID_SRCEPhraseStart', 'DISPID_SOTIsUISupported', 'SPWORDLIST',
    'SpeechPropertyAdaptationOn', 'DISPID_SGRsCommit',
    'SpStreamFormatConverter', 'ISpeechPhraseInfo', 'SVP_18',
    'SPSHT_EMAIL', 'SpPhraseInfoBuilder',
    'DISPID_SVSInputWordPosition', 'SVPAlert',
    'SSSPTRelativeToCurrentPosition', 'SVEStartInputStream',
    'eLEXTYPE_PRIVATE15', 'SRTEmulated', 'SGRSTTTextBuffer',
    'SpeechMicTraining', 'SpeechRetainedAudioOptions', 'SP_VISEME_11',
    'SECFEmulateResult', 'ISpeechLexiconPronunciations',
    'DISPID_SBSSeek', 'SpeechVoiceSpeakFlags', 'SREInterference',
    'DISPID_SVAudioOutput', 'DISPID_SASetState',
    'ISpeechPhraseReplacements', 'SPAR_Low', 'DISPID_SFSOpen',
    'SSTTWildcard', 'DISPID_SRCERecognition', 'SRTSMLTimeout',
    'SPEI_TTS_PRIVATE', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SDKEnumKeys', 'DISPID_SRRRecoContext',
    'SAFT22kHz8BitMono', 'DISPID_SWFEBlockAlign',
    'DISPID_SpeechPhraseRules', 'ISpObjectToken',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpeechLexiconWords',
    'SPFM_CREATE', 'DISPID_SGRsItem', 'SVP_10',
    'DISPID_SPRules_NewEnum', 'DISPID_SFSClose',
    'SGDSActiveUserDelimited', 'DISPID_SpeechLexiconWord',
    'ISpeechObjectTokenCategory', 'SpeechRegistryUserRoot',
    'SPCT_COMMAND', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SP_VISEME_15', 'DISPID_SRRecognizer', 'SVF_Stressed',
    'DISPID_SDKGetlongValue', 'SAFT32kHz16BitStereo',
    'eLEXTYPE_RESERVED4', 'DISPID_SpeechBaseStream',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'SpPhoneticAlphabetConverter', 'ISpeechPhraseReplacement',
    'DISPID_SVEAudioLevel', 'DISPID_SRGetPropertyNumber',
    'DISPID_SpeechRecoResultTimes', 'eLEXTYPE_PRIVATE8',
    'DISPID_SWFESamplesPerSec', 'SAFT44kHz16BitStereo',
    'DISPID_SGRsAdd', 'DISPID_SpeechLexicon', 'SP_VISEME_0',
    'DISPID_SPRNumberOfElements', 'STCRemoteServer',
    'DISPID_SRRAlternates', 'SpStream', 'ISpeechFileStream',
    'DISPID_SPERetainedSizeBytes', 'SPRULESTATE', 'SDKLLocalMachine',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SRRAudio', 'STCAll',
    'SAFT44kHz16BitMono', 'DISPID_SpeechPhraseElements',
    'SAFT12kHz16BitMono', 'eLEXTYPE_PRIVATE18', 'SPSHORTCUTTYPE',
    'SAFT11kHz16BitMono', 'DISPID_SRRSpeakAudio',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRGSetWordSequenceData', 'SpeechLoadOption',
    'DISPID_SVSpeak', 'SREHypothesis', 'SPWORD', 'SVP_17',
    'SPEI_MIN_TTS', 'DISPID_SRGIsPronounceable', 'DISPID_SVEWord',
    'DISPID_SRCPause', 'DISPID_SRCRetainedAudioFormat', 'SRESoundEnd',
    'DISPID_SPIGetDisplayAttributes', 'SPXRO_SML', 'SVEAllEvents',
    'DISPID_SRCResume', 'SpObjectToken', 'DISPID_SPEActualConfidence',
    'DISPID_SOTRemove', 'SP_VISEME_9', 'SPLO_STATIC',
    'SPPS_RESERVED3', 'DISPID_SGRsDynamic', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SGRsFindRule', 'DISPID_SOTGetAttribute', 'ISpVoice',
    'DISPID_SVSInputSentenceLength', 'ISpPhoneticAlphabetConverter',
    'SRADynamic', 'SPEI_PHRASE_START', 'ISpNotifySource',
    'SRTStandard', 'DISPID_SPIElements', 'SPBINARYGRAMMAR',
    'SPEI_START_SR_STREAM', 'ISpeechBaseStream',
    'ISpPhoneticAlphabetSelection', 'SGLexicalNoSpecialChars',
    'DISPID_SLPLangId', 'STSF_LocalAppData', 'ISpXMLRecoResult',
    'DISPID_SpeechVoiceStatus', 'SVP_14',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRGRules',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SDKSetLongValue',
    'SAFTText', 'eLEXTYPE_USER', 'SECFNoSpecialChars',
    'SPCONTEXTSTATE', 'SVP_9', 'DISPID_SRRTimes', 'DISPID_SAStatus',
    'DISPID_SPPFirstElement', 'SpeechCategoryPhoneConverters',
    'DISPID_SPPNumberOfElements', 'DISPID_SpeechRecoContext',
    'SpTextSelectionInformation', 'STSF_CommonAppData',
    'ISpRecoContext2', 'SPRULE', 'DISPID_SRCEBookmark',
    'DISPID_SRCEPropertyStringChange', 'SGSDisabled',
    'eLEXTYPE_PRIVATE16', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SABufferInfo', 'SDTAll', 'DISPID_SPAsItem', 'LONG_PTR',
    'SpeechUserTraining', 'SpeechRunState', 'SPPS_RESERVED1',
    'DISPID_SRCEAdaptation', 'DISPID_SLPSymbolic',
    'ISpeechLexiconWord', 'SDKLCurrentConfig', 'SDTProperty',
    'DISPID_SpeechAudioFormat', 'DISPID_SVSInputWordLength',
    'DISPID_SPCLangId', 'ISpObjectTokenCategory',
    'DISPID_SPIGrammarId', 'ISpMMSysAudio', 'SAFT16kHz16BitStereo',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SRGetFormat',
    'DISPID_SOTCDefault', 'DISPID_SpeechRecognizer', 'SPPHRASERULE',
    'SAFT16kHz16BitMono', 'ISpeechDataKey', 'DISPID_SpeechVoice',
    'DISPID_SRCVoice', 'SINoise', 'SpeechStreamSeekPositionType',
    'SVP_3', 'SAFT22kHz16BitMono', 'DISPID_SOTGetDescription',
    'SpeechAudioFormatGUIDWave', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SVSkip', 'DISPID_SVSLastBookmark',
    'SAFTCCITT_ALaw_22kHzMono', 'SPBO_AHEAD', 'DISPID_SWFEExtraData',
    'SPSHT_NotOverriden', 'SAFT11kHz8BitMono', 'SPBOOKMARKOPTIONS',
    'SLTUser', 'DISPID_SGRSTText', 'SAFT8kHz8BitStereo',
    'DISPID_SVWaitUntilDone', 'SPCS_DISABLED', 'SITooFast',
    'SVSFParseAutodetect', 'SAFTADPCM_44kHzMono', 'SPSNoun',
    'SP_VISEME_3', 'SPAO_NONE',
    'SpeechPropertyNormalConfidenceThreshold', 'SpeechDiscardType',
    'SVSFIsXML', 'SpObjectTokenCategory', 'SPWORDPRONUNCIATIONLIST',
    'SpeechRegistryLocalMachineRoot', 'eLEXTYPE_PRIVATE7',
    'DISPID_SLPType', 'SPWF_SRENGINE', 'DISPID_SPPConfidence',
    'SPEI_SOUND_END', 'DISPID_SVSLastResult', 'SAFTNonStandardFormat',
    'eLEXTYPE_PRIVATE19', 'SAFT8kHz8BitMono', 'SPPHRASEREPLACEMENT',
    'STSF_FlagCreate', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SOTCreateInstance',
    'DISPID_SOTsItem', 'DISPID_SRSClsidEngine', 'SVP_15',
    'SREStreamEnd', 'DISPID_SpeechPhoneConverter',
    'DISPID_SASCurrentSeekPosition', 'SPVPRI_OVER',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SDKDeleteKey',
    'SPEI_UNDEFINED', 'DISPID_SRGReset', 'SPEI_SR_BOOKMARK',
    'SpNotifyTranslator', 'SpeechPropertyResponseSpeed',
    'DISPID_SpeechMMSysAudio', 'SAFTGSM610_44kHzMono', 'SpMMAudioIn',
    'DISPID_SPRDisplayAttributes', 'SPAUDIOSTATE',
    'DISPID_SPCIdToPhone', 'SRSEIsSpeaking', 'DISPID_SPRsCount',
    'SPSSuppressWord', 'SpUnCompressedLexicon',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'ISpAudio',
    'SPSInterjection', 'SREAdaptation', 'SPEI_PROPERTY_STRING_CHANGE',
    'SP_VISEME_16', 'UINT_PTR', 'SVSFDefault',
    'DISPID_SOTCEnumerateTokens', 'SpVoice', 'SAFT8kHz16BitStereo',
    'SpeechAudioVolume', 'SPWORDPRONOUNCEABLE',
    'ISpeechLexiconPronunciation', 'SP_VISEME_20', 'SVPNormal',
    'ISpPhoneConverter', 'SPRECOSTATE', 'SPPS_LMA',
    'ISpSerializeState', 'SPEI_TTS_BOOKMARK',
    'DISPID_SVSRunningState', 'SPGS_DISABLED', 'ISpGrammarBuilder',
    'SVEPhoneme', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SRCESoundEnd',
    'DISPID_SGRSRule', 'DISPID_SBSRead', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SVEBookmark', 'SP_VISEME_2', 'DISPID_SPAPhraseInfo',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPRuleName',
    'SPEI_START_INPUT_STREAM', 'SpeechAudioFormatType',
    'SECHighConfidence', 'SVP_20', 'SPWORDTYPE', 'SPEI_END_SR_STREAM',
    'DISPID_SLWs_NewEnum', 'DISPID_SPERequiredConfidence',
    'SPEI_MAX_TTS', 'SPSHT_Unknown', 'SpeechBookmarkOptions',
    'SPEVENTENUM', 'DISPID_SLPPhoneIds',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SRCS_Disabled',
    'SPRECORESULTTIMES', 'DISPID_SPRulesCount',
    'SAFTNoAssignedFormat', 'SPRST_NUM_STATES', 'SPWT_LEXICAL',
    'DISPID_SRCERecognizerStateChange', 'DISPIDSPTSI', 'SVF_None',
    'SPWAVEFORMATTYPE', 'DISPID_SPRuleNumberOfElements',
    'SPRS_ACTIVE_USER_DELIMITED', 'SAFTCCITT_uLaw_44kHzMono',
    'ISpProperties', 'DISPID_SLPPartOfSpeech', 'DISPID_SOTsCount',
    'DISPID_SRSSupportedLanguages', 'DISPID_SAFGuid',
    'ISpResourceManager', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPIStartTime', 'ISpeechGrammarRuleStateTransition',
    'ISpStreamFormat', 'DISPID_SRCRetainedAudio', 'SpeechRuleState',
    'SRTReSent', 'SECFIgnoreWidth', 'DISPID_SGRAttributes',
    'Speech_Default_Weight', 'DISPID_SpeechPhraseAlternates',
    'SpeechDictationTopicSpelling', 'SPEI_PHONEME',
    'SpeechInterference', 'SpeechEngineProperties', 'ISpRecognizer',
    'SVP_5', 'DISPID_SVEViseme', 'SAFT11kHz8BitStereo',
    'SPAO_RETAIN_AUDIO', 'SPEI_FALSE_RECOGNITION',
    'SPEI_VOICE_CHANGE', 'DISPID_SVGetProfiles', 'eLEXTYPE_PRIVATE1',
    'SpFileStream', 'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SVEVoiceChange',
    'DISPID_SRSetPropertyString', 'SPPS_Modifier',
    'SAFTCCITT_ALaw_11kHzMono', 'SDTDisplayText', 'SFTSREngine',
    'SPSUnknown', 'IEnumSpObjectTokens', 'SSFMOpenReadWrite',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SRRPhraseInfo',
    'SpeechSpecialTransitionType', 'SVP_4', 'SpNullPhoneConverter',
    'eLEXTYPE_RESERVED6', 'DISPID_SASState',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SpeechLexiconProns',
    'DISPID_SRCreateRecoContext', 'SSTTDictation',
    'DISPID_SpeechLexiconPronunciation', 'SPINTERFERENCE_NOISE',
    'DISPID_SVSpeakCompleteEvent', 'SPPHRASE', 'SPPS_SuppressWord',
    'DISPID_SMSSetData', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SRRSetTextFeedback',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SpeechMemoryStream', 'SREPhraseStart', 'SPAR_High',
    'SpeechDisplayAttributes', 'SPAS_RUN', 'eLEXTYPE_LETTERTOSOUND',
    '__MIDL_IWinTypes_0009', 'SpInProcRecoContext',
    'SSSPTRelativeToEnd', 'DISPID_SPIReplacements',
    'DISPID_SGRSTPropertyName', 'SVSFNLPMask', 'SpeechVisemeType',
    'DISPID_SGRAddState', 'IInternetSecurityMgrSite',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SAFT22kHz16BitStereo',
    'SpeechTokenKeyAttributes', 'DISPID_SVAudioOutputStream',
    'SPLOADOPTIONS', 'SP_VISEME_8', 'SP_VISEME_14', 'SASRun',
    'DISPID_SAVolume', 'SAFT24kHz16BitMono', 'SLOStatic',
    'DISPID_SpeechPhraseProperties', 'SASPause',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SLPsCount',
    'eLEXTYPE_PRIVATE17', 'eLEXTYPE_PRIVATE10', 'SPEI_SR_PRIVATE',
    'SpeechAudioProperties', 'DISPID_SRGetPropertyString',
    'SP_VISEME_1', 'SRSInactiveWithPurge', 'SGDSActive',
    'SVF_Emphasis', 'DISPID_SRCEHypothesis', 'ISpeechAudioStatus',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpeechRecoGrammar',
    'DISPID_SLRemovePronunciation', 'DISPID_SPRuleEngineConfidence',
    'SpeechAddRemoveWord', 'SPBO_TIME_UNITS', 'DISPID_SRRTLength',
    'DISPID_SpeechPhraseReplacement', 'eLEXTYPE_PRIVATE20',
    'DISPID_SRProfile', 'SPEI_SR_RETAINEDAUDIO',
    'SAFT16kHz8BitStereo', 'SpeechCategoryRecognizers',
    'SVSFVoiceMask', 'SPEI_RESERVED3', 'DISPID_SRSetPropertyNumber',
    'SREPrivate', 'DISPID_SLWLangId', 'DISPID_SGRsCommitAndSave',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SpeechPhraseProperty',
    'SP_VISEME_21', 'ISpeechObjectToken', 'DISPID_SOTCategory',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SLAddPronunciation',
    'DISPID_SVSCurrentStreamNumber', 'SWTDeleted',
    'SAFT16kHz8BitMono', 'STCInprocServer', 'DISPID_SGRName',
    'DISPID_SRGDictationLoad', 'ISpeechRecognizerStatus',
    'SpeechTokenContext', 'SPRS_ACTIVE', 'DISPID_SLPs_NewEnum',
    'SPEI_RECOGNITION', 'eLEXTYPE_APP', 'SPWF_INPUT',
    'DISPID_SVVolume', 'SAFT32kHz8BitStereo', 'DISPID_SpeechAudio',
    'ISpDataKey', 'DISPID_SRDisplayUI', 'SGRSTTWildcard',
    'SPRST_ACTIVE', 'DISPID_SPANumberOfElementsInResult',
    'SAFT32kHz8BitMono', 'DISPID_SOTDataKey', 'DISPID_SOTCId',
    'SPSNotOverriden', 'DISPID_SOTCGetDataKey',
    'DISPID_SPARecoResult', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPAR_Medium', 'SSSPTRelativeToStart', 'DISPID_SOTId',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SPIAudioSizeBytes',
    'ISpeechAudio', 'DISPID_SDKEnumValues',
    'DISPID_SpeechLexiconWords', 'DISPID_SPPChildren', 'SP_VISEME_7',
    'SREPropertyNumChange', 'SpeechPropertyResourceUsage',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVSVisemeId', 'DISPIDSPTSI_ActiveLength', 'ISpPhraseAlt',
    'ISpeechRecoContext', 'SBONone', 'DISPID_SRCEInterference',
    'SpCustomStream', 'ISpeechGrammarRule', 'SDTReplacement',
    'SpAudioFormat', 'DISPID_SPIProperties', 'DISPID_SGRs_NewEnum',
    'DISPID_SVSPhonemeId', 'DISPID_SRRTStreamTime',
    'DISPID_SRAudioInput', 'SPAS_CLOSED', 'SVSFParseSsml',
    'SPWT_DISPLAY', 'SAFT24kHz8BitMono', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SAFSetWaveFormatEx', 'SPPS_Unknown', 'SWTAdded',
    'SPGS_ENABLED', 'DISPID_SGRSTransitions',
    'SDA_One_Trailing_Space', 'DISPID_SDKOpenKey',
    'SpInprocRecognizer', 'DISPID_SWFEChannels', 'SASStop',
    'DISPID_SLWsItem', 'SPAUDIOBUFFERINFO', 'ISpRecoGrammar2',
    'DISPID_SOTMatchesAttributes',
    'ISpeechGrammarRuleStateTransitions', 'ISpeechRecoResultTimes',
    'SpeechEmulationCompareFlags', 'DISPID_SPEsCount',
    'DISPID_SPPsCount', 'DISPID_SMSADeviceId', 'DISPID_SVEPhoneme',
    'DISPID_SVESentenceBoundary', 'DISPID_SPPsItem',
    'SWPUnknownWordUnpronounceable', 'SPAS_STOP',
    'SpeechTokenShellFolder', 'DISPID_SRRAudioFormat', 'SP_VISEME_5',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SpPhoneConverter',
    'SAFT48kHz16BitMono', 'DISPID_SPPId', 'DISPID_SPRuleParent',
    'SRERequestUI', 'eLEXTYPE_RESERVED8', 'DISPID_SASFreeBufferSpace',
    'SRTAutopause', 'DISPID_SRGCommit', 'SVSFPersistXML',
    'SpeechRecognitionType', 'DISPID_SOTSetId',
    'DISPID_SVEVoiceChange', 'eLEXTYPE_PRIVATE4', 'SVP_16',
    'DISPID_SAEventHandle', 'DISPID_SRIsUISupported',
    'SAFT12kHz8BitMono', 'SpeechRuleAttributes',
    'DISPID_SpeechGrammarRules', 'SAFT48kHz8BitStereo',
    'DISPID_SpeechPhraseRule', 'ISpeechRecoResult',
    'SPFM_OPEN_READWRITE', 'DISPID_SBSWrite', 'SDTAlternates',
    'SPPS_Interjection', 'SPPS_Noncontent', 'SPSHORTCUTPAIRLIST',
    'SpLexicon', 'SVP_12', 'SPSMF_UPS', 'SGSExclusive',
    'DISPID_SGRClear', 'SpeechAudioState',
    'DISPID_SPAStartElementInResult', 'SAFTDefault',
    'ISpeechAudioFormat', 'SpeechPropertyHighConfidenceThreshold',
    'ISpeechPhraseProperty', 'SPPARTOFSPEECH',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SVAlertBoundary',
    'DISPID_SOTGetStorageFileName', 'ISpeechPhraseInfoBuilder',
    'SPEI_RESERVED1', 'SpeechEngineConfidence', 'SRATopLevel',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVSFNLPSpeakPunc',
    'DISPID_SLGetWords', 'ISpeechPhraseAlternate',
    'ISpeechPhraseRules', 'SREAllEvents', 'SPCS_ENABLED', 'SGDisplay',
    'SPSModifier', 'ISpeechVoiceStatus', 'SAFTADPCM_8kHzMono',
    'SpeechCategoryRecoProfiles', 'SpeechFormatType',
    'ISpeechRecognizer', 'DISPID_SRGDictationUnload',
    ...
    'DISPID_SRGState', 'SECNormalConfidence',
    'DISPID_SRCCreateGrammar', 'SAFTCCITT_ALaw_22kHzStereo',
    'SpeechCategoryAppLexicons', 'SPSERIALIZEDRESULT', 'SPSLMA',
    'SSFMCreateForWrite', 'SRTExtendableParse',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SPRuleFirstElement',
    'ISpeechMemoryStream', 'SPSEMANTICFORMAT', 'SAFT12kHz8BitStereo',
    'DISPID_SRGId', 'SPEI_REQUEST_UI', 'SLTApp',
    'DISPID_SVEStreamEnd', 'SAFT24kHz8BitStereo',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpRecoContext',
    'SPCT_SUB_DICTATION', 'DISPID_SGRSTsCount',
    'DISPID_SpeechPhraseElement', 'SPWORDPRONUNCIATION',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SGRSTPropertyId', 'SVP_6',
    'SAFT22kHz8BitStereo', 'SPXRO_Alternates_SML', 'SP_VISEME_13',
    'SPPS_NotOverriden', 'DISPID_SRRGetXMLErrorInfo', 'SDTAudio',
    'DISPID_SABufferNotifySize', 'SPSMF_SAPI_PROPERTIES',
    'eLEXTYPE_PRIVATE14', 'SPRECOCONTEXTSTATUS', 'SpeechTokenKeyUI',
    ...
    'SDA_No_Trailing_Space', 'eLEXTYPE_PRIVATE13', 'SGDSInactive',
    'DISPID_SRCERecognitionForOtherContext',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpRecoResult',
    'SpeechCategoryAudioOut', 'SpeechCategoryAudioIn',
    'SPEI_RECO_STATE_CHANGE', '_SPAUDIOSTATE', 'SGRSTTRule',
    'SPEI_END_INPUT_STREAM', 'SAFTADPCM_8kHzStereo',
    'SpeechVisemeFeature', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SRCBookmark', 'DISPID_SpeechObjectTokens',
    'ISpeechResourceLoader', 'IStream', 'DISPIDSPRG',
    'DISPID_SRStatus', 'SECLowConfidence', 'SVSFIsNotXML',
    'ISpeechXMLRecoResult', 'SPADAPTATIONRELEVANCE',
    'DISPID_SWFEFormatTag', 'ISpNotifySink', 'SAFTGSM610_8kHzMono',
    'DISPID_SRGSetTextSelection', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRCVoicePurgeEvent', 'SVP_19', 'SP_VISEME_18',
    'SVSFParseMask', 'SPINTERFERENCE_NOSIGNAL', 'DISPID_SPIRule',
    'SVEWordBoundary', 'DISPID_SVVoice', 'SPRST_INACTIVE',
    'SWPUnknownWordPronounceable', 'SVSFParseSapi',
    'DISPID_SRRDiscardResultInfo', 'SRERecognition',
    'DISPID_SVStatus', 'DISPID_SLGetPronunciations',
    'DISPID_SPISaveToMemory', 'SVP_7', 'DISPID_SVSpeakStream',
    'SREPropertyStringChange', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SWFEAvgBytesPerSec', 'SREStreamStart',
    'SAFTCCITT_uLaw_22kHzStereo', 'ISpStreamFormatConverter',
    'SRAExport', 'ISpeechPhraseRule', 'SRCS_Enabled',
    'DISPID_SPEsItem', 'DISPID_SLWsCount', 'SAFT12kHz16BitStereo',
    'ISpeechAudioBufferInfo', 'SPRS_INACTIVE', 'SpeechVoiceEvents',
    'SPDKL_LocalMachine', 'SDA_Consume_Leading_Spaces', 'SP_VISEME_6',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPEI_RESERVED6', 'SVP_8',
    'SVEViseme', 'SVEEndInputStream', 'DISPID_SLGenerationId',
    'DISPID_SpeechFileStream', '_ISpeechRecoContextEvents',
    'DISPID_SRIsShared', 'SpMMAudioOut', 'ISpeechPhraseElement',
    'DISPID_SPPName', 'SAFT48kHz8BitMono', 'SFTInput',
    'eLEXTYPE_PRIVATE11', 'DISPID_SAFType', 'SpeechWordPronounceable',
    'DISPID_SWFEBitsPerSample', 'DISPID_SVRate',
    'DISPID_SASNonBlockingIO', 'DISPID_SRGCmdLoadFromFile',
    'SPXMLRESULTOPTIONS', 'SPGS_EXCLUSIVE',
    'SWPKnownWordPronounceable', 'SPDKL_CurrentConfig',
    'SPEI_RESERVED2', 'ISequentialStream', 'eLEXTYPE_PRIVATE6',
    'SRAONone', 'ISpeechRecoResult2', 'DISPID_SDKSetStringValue',
    'ISpShortcut', 'ISpeechVoice', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRCState', 'DISPID_SRGCmdLoadFromResource', 'SITooSlow',
    'SPSEMANTICERRORINFO', 'DISPID_SPRuleChildren',
    'eLEXTYPE_VENDORLEXICON', 'SVP_21', 'SAFTGSM610_22kHzMono',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SPRuleId',
    'DISPID_SDKSetBinaryValue', 'SPTEXTSELECTIONINFO', 'SPVISEMES',
    'SpeechRecognizerState', 'ISpeechLexicon', 'DISPID_SRRTTickCount',
    'SSTTTextBuffer', 'SPLEXICONTYPE',
    'DISPID_SASCurrentDevicePosition', 'SPCT_SUB_COMMAND',
    'SAFT32kHz16BitMono', 'SPEI_MIN_SR', 'DISPID_SOTs_NewEnum',
    'DISPID_SOTDisplayUI', 'DISPID_SABIEventBias',
    'DISPID_SRRGetXMLResult', 'DISPID_SPILanguageId',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SDKGetBinaryValue',
    'SP_VISEME_12', 'SPVPRI_NORMAL', 'DISPID_SLWPronunciations',
    'DISPID_SRCEventInterests', 'SINoSignal', 'eLEXTYPE_PRIVATE2',
    'SpMemoryStream', 'SAFTADPCM_44kHzStereo',
    'DISPID_SpeechRecoResult2', 'DISPID_SPAsCount',
    'eLEXTYPE_MORPHOLOGY', 'SP_VISEME_17', 'SPGRAMMARSTATE',
    'SPEI_ADAPTATION', 'DISPID_SVResume', 'SBOPause',
    'SREStateChange', 'DISPID_SADefaultFormat', 'SVP_0', 'SVP_11',
    'ISpeechMMSysAudio', 'SpeechLexiconType', 'SINone',
    'DISPID_SOTCSetId'
]

_check_version('1.1.14', 1700064255.416021)
